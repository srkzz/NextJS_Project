                    ...
                    <div className="text-center">
                        ...
                        <form action="https://api.web3forms.com/submit" method="POST"  classNameName='mt-10 w-full max-w-2x1 flex flex-col gap-7 glassmorphism'>
                            ...
                            <div className="mb-6">
                                ...
                                <input type="text" name="phone" id="phone" placeholder="+351 92X XXX XXX" required className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                            </div>
                            <div className="mb-6">
                                <label for="message" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">Sua Mensagem</label>
                            ...
                            <div className="mb-6">
                                <button type="submit" className="w-full px-3 py-4 text-white bg-green-300 rounded-md focus:bg-indigo-600 focus:outline-none">
                                    Send Message
                                </button>
                            </div>
